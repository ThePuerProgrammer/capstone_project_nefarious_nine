...
var cleanGlowParticle = preload("res://ChillZone/wash_pomopet_testing/CleanGlowParticle.tscn")
...
func playCleanEffects():
	...
	# 	Sparkle Effect
	$CleanSparkle/AnimationPlayer.play("fade_in")
...
func _on_CleanEffectTimer_timeout():
	...
	$CleanSparkle/AnimationPlayer.play("fade_out")
