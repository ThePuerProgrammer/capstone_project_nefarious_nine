...
onready var timer = get_node("PomoDefense_Transition_Timer")
...
onready var anim = get_node("PomoDefense_Animator")
...
func _on_PomoDefense_Transition_Timer_timeout():
	anim.play("FADE_IN")
	get_tree().change_scene("res://Pomodefense/SceneHandler.tscn")
